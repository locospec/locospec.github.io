---
title: Mutator Schema
description: Define how create, update, and delete operations should behave via declarative specs.
---

A **Mutator Schema** defines how a record can be **created**, **updated**, or **deleted**. It represents a form-based mutation layer on top of your model—complete with fields, validations, generators, and layout.
...
👉 [`mutator.json`](https://locospec.com/schemas/mutator.json)
