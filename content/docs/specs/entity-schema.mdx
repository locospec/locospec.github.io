...
The **Entity Schema** defines how a **single record** of a model should be presented—think detail pages, summary cards, or read-only views. It focuses entirely on layout: grouping, nesting, and arranging fields into readable sections.
...
👉 [`entity.json`](https://locospec.com/schemas/entity.json)
