...
A **View Schema** defines how data from a model should be queried, filtered, and presented—typically in a table, list, or kanban view. It’s where **search**, **pagination**, **filters**, and **row actions** come together.
...
👉 [`view.json`](https://locospec.com/schemas/view.json)
